...
export default function Progress() {
    return (
        <div className="px-5 py-3">
            ...
            <ul className="w-full flex justify-between items-center text-gray500 mt-2 px-2">
                <li className="flex flex-col items-center">
                    <p className="pretendard-semibold text-xl">0</p>
                    <span className="text-sm">주문접수</span>
                </li>
                <li>
                ...
                <li className="flex flex-col items-center">
                    <p className="pretendard-semibold text-xl">0</p>
                    <span className="text-sm">상품준비중</span>
                </li>
                <li>
                    <ChevronRight strokeWidth={1.5} />
                </li>
                <li className="flex flex-col items-center">
                    <p className="pretendard-semibold text-xl">0</p>
                    <span className="text-sm">배송·픽업중</span>
                </li>
                <li>
                    <ChevronRight strokeWidth={1.5} />
                </li>
                <li className="flex flex-col items-center text-gray1000">
                    ...
                    <span className="text-sm">인수완료</span>
                </li>
            </ul>
        </div>
    );
